...
class BGPatternFuserConfig:
    ...
    def __post_init__(self):
        ...
        self.mgepd_dir = os.path.join(self.root_dir, "fusion", self.dst_dir, "gep_mhw1")
        self.mgepp_dir = os.path.join(self.root_dir, "fusion", self.dst_dir, "gep_mhw3")
        self.mfused_dir = os.path.join(self.root_dir, "fusion", self.dst_dir, "fused_mhw1")
        ensure_dir(self.fusion_dir)
        ensure_dir(self.gep_dir)
        ensure_dir(self.mgepd_dir)
        ensure_dir(self.mgepp_dir)
        ensure_dir(self.mfused_dir)
